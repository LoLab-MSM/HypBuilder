...
Rule('binding_0_B_binder_C_binder_target', B(A=ANY, C=None) + C(B=None, D=None) | B(A=ANY, C=1) % C(B=1, D=None), binding_0_B_binder_C_binder_target_2kf, binding_0_B_binder_C_binder_target_1kr)
Rule('binding_0_C_binder_D_binder_target', C(B=ANY, D=None) + D(C=None) | C(B=ANY, D=1) % D(C=1), binding_0_C_binder_D_binder_target_2kf, binding_0_C_binder_D_binder_target_1kr)
