...
Rule('inhibition_0_C_inhibitor_D_inh_target', C(D=None, A=ANY) + D(E=None, C=None) | C(D=1, A=ANY) % D(E=None, C=1), inhibition_0_C_inhibitor_D_inh_target_2kf, inhibition_0_C_inhibitor_D_inh_target_1kr)
