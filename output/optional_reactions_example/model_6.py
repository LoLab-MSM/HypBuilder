...
Rule('inhibition_0_A_inhibitor_C_inh_target', A(C=None) + C(A=None, B=None) | A(C=1) % C(A=1, B=None), inhibition_0_A_inhibitor_C_inh_target_2kf, inhibition_0_A_inhibitor_C_inh_target_1kr)
Rule('inhibition_0_B_inhibitor_C_inh_target', B(C=None) + C(A=None, B=None) | B(C=1) % C(A=None, B=1), inhibition_0_B_inhibitor_C_inh_target_2kf, inhibition_0_B_inhibitor_C_inh_target_1kr)

Initial(D(E=None), D_0)
Initial(E(D=None), E_0)
Initial(A(C=None), A_0)
Initial(C(A=None, B=None), C_0)
