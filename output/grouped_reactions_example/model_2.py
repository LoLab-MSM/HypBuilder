...
Rule('inhibition_0_A_inhibitor_B_inh_target', A(B=None, C=None) + B(A=None, C=None) | A(B=1, C=None) % B(A=1, C=None), inhibition_0_A_inhibitor_B_inh_target_2kf, inhibition_0_A_inhibitor_B_inh_target_1kr)
Rule('inhibition_0_B_inhibitor_C_inh_target', B(A=None, C=None) + C(B=None, A=None) | B(A=None, C=1) % C(B=1, A=None), inhibition_0_B_inhibitor_C_inh_target_2kf, inhibition_0_B_inhibitor_C_inh_target_1kr)
